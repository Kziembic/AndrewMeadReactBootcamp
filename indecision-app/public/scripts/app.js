...
var me = new Student('Krzysztof Ziembicki', 31, 'Telecommunications');
console.log(me.getDescription());

var other = new Student();
console.log(other.getDescription());

var traveler = new Traveler('Krzysztof Ziembicki', 32, 'Giedlarowa');
console.log(traveler.getGreeting());

var travelerWithoutTravel = new Traveler('Zaneta Szulhan', 31);
